...
describe("Unsafe API calls", () => {
  describe("GET endpoints", () => {
    ...
    it("should throw ApiError on HTTP error status", async () => {
      ...
      await expect(client.api.users.id("999").get.orThrow()).rejects.toThrow(ApiError);
    ...
    it("should throw ValidationError on response validation failure", async () => {
      ...
      await expect(client.api.users.id("123").get.orThrow()).rejects.toThrow(ValidationError);
    ...
    it("should throw NetworkError on network failure", async () => {
      ...
      await expect(client.api.users.id("123").get.orThrow()).rejects.toThrow(NetworkError);
    });
  });
  ...
  describe("DELETE endpoints", () => {
    it("should return data directly on successful DELETE request with response", async () => {
      ...
      const deleteResult = await client.api.users.id("123").confirm.delete.orThrow();
  ...
  describe("Complex scenarios", () => {
    ...
    it("should work with nested path parameters", async () => {
      ...
      const post = await client.api.users.userId("456").posts.postId("123").get.orThrow();
